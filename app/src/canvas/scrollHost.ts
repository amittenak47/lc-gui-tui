/**
 * Nested scrollers inside a markdown page.
 *
 ...
 * could ever reach — the markdown layer is `pointer-events: none` so a pen
 ...
 * markdown page — `null` if the pointer is on ordinary prose.
 *

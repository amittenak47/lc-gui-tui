  ...
  return (
    <>
      ...
      <SettingsBlock
        ...
        hint={
          <>
            Shape only: slow down and the line fattens, speed up and it
            thins. This is not graphite — that is Speed blot. Body (below)
            tunes the rest blobs at the ends. Saved on this device only.
          </>
        }
      >
        <SettingsRange
      ...
      {speedPct > 0 && (
        <SettingsBlock
          ...
          hint={
            <>
              Tunes Speed ink at the endpoints: left (negative) kills the
              round rest blob, 0 leaves Speed ink as-is, right fattens the
              ends. Hidden when Speed ink is Off. Saved on this device only.
            </>
          }
        >
          <SettingsRange
      ...
      <SettingsBlock
        ...
        hint={
          <>
            Ink drying over a long stroke: the further you travel, the more
            the line fades. Pace does not wash it. Off keeps full ink the

 ...
 * saveable into a wheel slot and indistinguishable from the app being broken.
 * One preset stored that way cost an evening of hunting the renderer. The
 * bottom of the dial is now the faintest usable ink instead, and because the
 * clamp is shared with `resolveInkBoldness`, presets and already-drawn strokes
 * that recorded 0 come back at the floor rather than staying invisible.
 */
